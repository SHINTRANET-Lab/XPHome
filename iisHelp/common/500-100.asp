...
<table width="410" cellpadding="3" cellspacing="5">
  ...
  <tr>    
	...
	<h1 style="COLOR:000000; FONT: 13pt/15pt ＭＳ Ｐゴシック"><!--Problem-->ページを表示できません</h1>
    </td>
  </tr>
  
  <tr>
    <td width="400" colspan="2">
	<font style="COLOR:000000; FONT: 8pt/11pt ＭＳ Ｐゴシック">接続しようとするページに問題があるため、そのページを表示できません。</font></td>
  </tr>
  ...
  <tr>
	...
	<ul>
      <li id="instructionsText1">[<a href="javascript:location.reload()">更新</a>] をクリックするか、後で再度実行してください。<br>
      </li>
	  ...
	  必要な情報が記載されたページへのリンクを探します。</li>
    </ul>
	
    <h2 style="font:8pt/11pt ＭＳ Ｐゴシック; color:000000">HTTP 500.100 - 内部サーバー エラー - ASP エラー<br>
    インターネット インフォメーション サービス</h2>
...
<%  strQueryString = "prd=iis&sbp=&pver=5.0&ID=500;100&cat=" & Server.URLEncode(objASPError.Category) & _
    ...
    strQueryString
%>
<a href="<%= strURL %>">Microsoft サポート</a>
</li>
</p>
