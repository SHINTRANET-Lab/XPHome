...
<BODY bgcolor="#000000">
<SPAN id = "content" STYLE="POSITION: relative; TOP: 4px"><IMG alt="目次" hspace=0 src="cont.gif" border=0 ></SPAN> <SPAN STYLE="LEFT: -4px; POSITION: relative; TOP: 4px"><A id="index" href="Index.asp" hidefocus><IMG alt="索引" hspace=0 src="NoIndex.gif" border=0 ></A></SPAN>

<SPAN STYLE="LEFT: -8px; POSITION: relative; TOP: 4px"><A id="search" href="Search.asp" hidefocus><IMG alt="検索" src="nosearch.gif" border=0 ></A></SPAN>

<table border="0" width="262" height="31" cellspacing=2 bgcolor="white" bordercolor="white">
<TR><TD align="right">
<A id="printBtn" onclick=TOCPrint_Click() href="#Ptoc" hidefocus><IMG align="baseline" alt="目次からトピックまたはノードを印刷します" src ="print.gif" border=0 ></a><a name="Ptoc"></a> <A id="synch" onclick=TOCSynch_Click() href="#Stoc" hidefocus><IMG align="baseline" alt="目次と右側のフレームを同期します" src ="synch.gif" border=0 ></a><a name="Stoc"></a>

</td></TR></table>

<div style="font-family:ＭＳ Ｐゴシック;font-size:9pt">
