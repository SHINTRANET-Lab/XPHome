...
<html dir=LTR><HEAD><TITLE>目次</TITLE>
...
<SPAN STYLE="position:  relative; left: 0; top: 4"><IMG SRC="Cont.gif" border="0" alt="目次"></Span>

<SPAN STYLE="position:  relative; left: -4; top: 4"><A HREF="Index.asp"><IMG SRC="NoIndex.gif" border="0" alt="索引"></A></Span>


<SPAN STYLE="position:  relative; left: -8; top: 4"><A HREF="Search.asp"><IMG SRC="NoSearch.gif" border="0" ALT="検索"></A></Span>
...
<TD align="right">
<SPAN STYLE="position:  relative; left: 1; top: 0"><a href="#Ptoc" onclick="TOCPrint_Click()"><img src="print.gif" border="0" alt="目次からトピックまたはノードを印刷します"></a><a name="Ptoc"></a></SPAN>
</td>
<td align="left">
<a href="#Stoc" onclick="TOCSynch_Click()"><img src="synch.gif" border="0" alt="目次と右側のフレームを同期します"></a><a name="Stoc"></a>
</td></tr></table>
