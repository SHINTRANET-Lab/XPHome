...
<!-- noprod --> <% @language=vbscript %>
<html dir=LTR>
<head>
	<title> ここにページのタイトルを入力してください </title>
</head>
...
IF rst.EOF THEN
	Response.Write "データベースへの入力がありません。"
ELSE%>
	<tr>
	<% 
	
	'Response.Write "<td width=200><center>レコードの削除</center></td>"
	...
	WHILE NOT rst.EOF %>
		...
		'Response.Write "<td align=left valign=top bgcolor='#ffffff'><a href=viewdb.asp?id=" & rst(0) & ">削除</a></td>"		
